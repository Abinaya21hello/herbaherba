...
const SignIn = () => {
  ...
  <div className="form-group mt-2 mb-2 w-100">
    <Button
      ...
      type="submit"
      style={{
        background: "linear-gradient(135deg, #f7b733, #fc4a1a)", // Bright yellow to vibrant orange
  ...
  >
    Forgot Password?
      ...
      >
    <Box sx={{ ...modalStyle, width: '300px', padding: '16px' }}>
  ...
  sx={{ fontSize: '1.5rem !important' }} // Adjust the font size here
>
  Forgot Password
</Typography>
    <IconButton
      ...
      className="closeIcon"
      sx={{ padding: '8px' }} // Adjust padding to reduce button size
    >
      <CloseIcon />
    </IconButton>
  </div>
