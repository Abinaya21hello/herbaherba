...
const SignUp = () => {
  ...
  .matches(
    /^[a-zA-Z0-9\s\/]+$/,
    "Street should only contain letters, numbers, spaces, and '/'"
  )
  ...
  const borderStyle = formik.touched.gender && formik.errors.gender
    ? '1px solid red'
    : '1px solid #ced4da';
  ...
  return (
    <>
      <section className="signUp mb-5">
        ...
        <div className="loginWrapper" style={{background: "linear-gradient(135deg, #f0f8ff, #d0f0c0)"}}>
  ...
  <Link
    ...
    onMouseEnter={(e) => (e.target.style.color = "#4F85CF")} // Green color on hover
    onMouseLeave={(e) => (e.target.style.color = "#4F85CF")}    // Reverts to black
  >
    Sign In
  </Link>
</p>
      ...
      >
        <DialogTitle id="form-dialog-title" style={{fontSize:"12px !important"}}>Verify OTP</DialogTitle>
        <DialogContent>
          <TextField
            autoFocus
            margin="dense"
