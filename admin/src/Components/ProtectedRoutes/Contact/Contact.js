  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setContacts((prevContacts) =>
        prevContacts.filter((contact) => contact._id !== currentContact._id)
      );
      setFilteredContacts((prevFilteredContacts) =>
        prevFilteredContacts.filter(
    ...
    <Container>
      ...
      {error && (
        <Typography color="error">
          Error fetching contacts. Please try again.
        </Typography>
      )}
      <SearchBar
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            ...
            <strong>{currentContact ? currentContact.name : ""}</strong>?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
